...
./autogen.sh
./configure --host=i686-w64-mingw32 LDFLAGS="-L./deps/i686-w64-mingw32/lib -static" CFLAGS="-Wall -O2 -fomit-frame-pointer -I./deps/i686-w64-mingw32/include -std=c99 -DWIN32 -DCURL_STATICLIB -DPTW32_STATIC_LIB" --with-libcurl=deps/i686-w64-mingw32
make
strip -p --strip-debug --strip-unneeded sugarmaker.exe

# PACKAGE
RELEASE=sugarmaker-v2.5.0-sugar1-w32-static
rm -rf $RELEASE
mkdir $RELEASE
